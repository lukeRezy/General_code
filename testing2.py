...
def ask_box(all_dir):
    ...
    #if len(all_dir) == 1:
        #canvas.configure(scrollregion=(0, -50, 0, 80))
        #root.geometry('{}x{}'.format(500, 125))
        #canvas.config(width = 500, height = 125)
    #elif len(all_dir) == 2:
        #canvas.configure(scrollregion=(0, -90, 0, 130))
        #root.geometry('{}x{}'.format(500, 225))
        #canvas.config(width = 500, height = 215)
    #elif len(all_dir) == 3:
        #canvas.configure(scrollregion=(0, -130, 0, 180))
        #root.geometry('{}x{}'.format(500, 225))
        #canvas.config(width = 500, height = 305)
    #elif len(all_dir) == 4:
        #canvas.configure(scrollregion=(0, -170, 0, 230))
        #root.geometry('{}x{}'.format(500, 225))
        #canvas.config(width = 500, height = 395)        
